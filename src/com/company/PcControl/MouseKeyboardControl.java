...
public class MouseKeyboardControl {
    Robot robot; // The object the performs the task in absence of the human
    ...
    } // Constructor initializes the robot

    public void leftClick() {
        robot.mousePress(InputEvent.BUTTON1_MASK);
        robot.mouseRelease(InputEvent.BUTTON1_MASK);
    } // Performs the mouse left click operation

    public void doubleClick() {
        leftClick();
        robot.delay(500);
        leftClick();
    } // Performs the double- click operation using the leftClick method

    public void rightClick() {
        robot.mousePress(InputEvent.BUTTON3_MASK);
        robot.mouseRelease(InputEvent.BUTTON3_MASK);
    } // Performs the mouse right click operation

    public void mouseMove(int x, int y) {
        robot.mouseMove(x, y);
    } // Moves the mouse pointer to the new x,y co-ordinates

    public void mouseWheel(int wheelAmount) {
        robot.mouseWheel(wheelAmount);
    } // Moves the scroll wheel by a given amount x as passed in the mehtod

    public void keyPress(int keyCode) {
        robot.keyPress(keyCode);
    } // Key corresponding to the key-code gets pressed

    public void keyRelease(int keyCode) {
        robot.keyRelease(keyCode);
    } // Key corresponding to the key-code gets released
    ...
    } // Allows typing for several key-strokes held together
    ...
    } // Types the given character using its keyCodes, via Switch Case

    public void typeCharacter(int keyCode) {
        robot.keyPress(keyCode);
        robot.delay(10);
        robot.keyRelease(keyCode);
    } // Enters the character according to the key_code

    public void pressLeftArrowKey() {
        typeCharacter(VK_LEFT);
    }// Performs the operation performed by the left arrow key

    public void pressDownArrowKey() {
        typeCharacter(VK_DOWN);
    } // Performs the operation performed by the down arrow key

    public void pressRightArrowKey() {
        typeCharacter(VK_RIGHT);
    } // Performs the operation performed by the right arrow key

    public void pressUpArrowKey() {
        typeCharacter(VK_UP);
    } // Performs the operation performed by the up arrow key

    public void pressF5Key() {
        typeCharacter(VK_F5);
    } // Performs the operation performed by the F5 key
